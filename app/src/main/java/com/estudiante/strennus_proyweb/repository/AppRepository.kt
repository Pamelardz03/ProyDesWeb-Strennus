...
class AppRepository(
    ...
    suspend fun insertarEjercicioPersonalizado(ejercicio: EjercicioPersonalizado) =
        ejercicioPersonalizadoDao?.insertar(ejercicio)
    suspend fun obtenerEjerciciosPersonalizados(usuarioId: Int): List<EjercicioPersonalizado> =
        ejercicioPersonalizadoDao?.obtenerTodos(usuarioId) ?: emptyList()
    fun obtenerEjerciciosPersonalizadosLive(usuarioId: Int): LiveData<List<EjercicioPersonalizado>>? =
        ejercicioPersonalizadoDao?.obtenerPorUsuario(usuarioId)
}